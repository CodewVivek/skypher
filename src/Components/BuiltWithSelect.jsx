...
const ReactIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="2.5" fill="#61DAFB" /><g stroke="#61DAFB" strokeWidth="2" fill="none"><ellipse rx="11" ry="4.2" transform="matrix(.866 .5 -.866 .5 16 16)" /><ellipse rx="11" ry="4.2" transform="matrix(-.866 .5 .866 .5 16 16)" /><ellipse rx="11" ry="4.2" transform="matrix(1 0 0 1 16 16)" /></g></svg>
);
const NodejsIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><path d="M16 2.7l12.1 7v12.6L16 29.3 3.9 22.3V9.7L16 2.7z" fill="#539E43" /><path d="M16 4.6l10.1 5.8v11.2L16 27.4l-10.1-5.8V10.4L16 4.6z" fill="#fff" /><path d="M16 6.5l8.1 4.7v9.4L16 25.3l-8.1-4.7v-9.4L16 6.5z" fill="#539E43" /></svg>
);
const TypeScriptIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#3178C6" /><path d="M13.5 14.5v-2h-7v2h2.5v7h2v-7h2.5zm2.5 7v-2h4.5v-1.5h-4.5v-2h6.5v2h-2v1.5h2v2h-6.5z" fill="#fff" /></svg>
);
const NextjsIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#fff" /><path d="M7.5 16c0-4.7 3.8-8.5 8.5-8.5s8.5 3.8 8.5 8.5-3.8 8.5-8.5 8.5S7.5 20.7 7.5 16zm8.5-7a7 7 0 100 14 7 7 0 000-14z" fill="#000" /><path d="M20.5 20.5l-9-9" stroke="#000" strokeWidth="1.5" /></svg>
);
const ReduxIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#764ABC" /><path d="M23.2 20.7c.2-1.2-.7-2.3-2-2.3-.7 0-1.3.3-1.7.8-2.2-1.1-4.2-2.7-5.7-4.7.2-.4.3-.8.3-1.2 0-1.2-1-2.2-2.2-2.2s-2.2 1-2.2 2.2c0 .7.3 1.3.8 1.7-1.1 2.2-1.7 4.7-1.7 7.3 0 1.2 1 2.2 2.2 2.2.7 0 1.3-.3 1.7-.8 2.2 1.1 4.7 1.7 7.3 1.7 1.2 0 2.2-1 2.2-2.2 0-.7-.3-1.3-.8-1.7z" fill="#fff" /></svg>
);
const FirebaseIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><path d="M6 26l10-20 10 20H6z" fill="#FFA000" /><path d="M16 6l10 20H6L16 6z" fill="#FFCA28" /></svg>
);
const TailwindIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><path d="M16 10c-4 0-6.7 2-8 6 1.3-2 3-3 5-3 1.2 0 2.2.4 3 1.2.8.8 1.8 1.2 3 1.2 2 0 3.7-1 5-3-1.3 4-4 6-8 6-4 0-6.7-2-8-6 1.3 4 4 6 8 6 4 0 6.7-2 8-6-1.3 2-3 3-5 3-1.2 0-2.2-.4-3-1.2-.8-.8-1.8-1.2-3-1.2z" fill="#38BDF8" /></svg>
);
const JavaScriptIcon = () => (
    <svg className="w-full h-full" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#F7DF1E" /><path d="M19.5 22.5c.3.5.7.8 1.3.8.6 0 1-.3 1-.8 0-.5-.3-.7-1.1-1.1l-.4-.2c-1.2-.5-2-1.1-2-2.3 0-1.1.8-2 2.1-2 1 0 1.7.3 2.2 1.2l-1.2.8c-.2-.4-.5-.6-1-.6-.5 0-.8.2-.8.6 0 .4.3.6 1.1 1l.4.2c1.3.6 2.1 1.2 2.1 2.4 0 1.4-1.1 2.1-2.3 2.1-1.2 0-2-.6-2.4-1.4l1.2-.7zm-5.2.1c.2.4.4.7.9.7.5 0 .8-.2.8-.7v-4.2h1.5v4.2c0 1.3-.8 2-2.2 2-1.2 0-2-.6-2.4-1.4l1.2-.7z" fill="#000" /></svg>
);
...
const MultiValueLabel = (props) => (
    <components.MultiValueLabel {...props}>
        {props.data.icon && (
            <span className="w-6 h-6 mr-2 flex items-center justify-center">{props.data.icon}</span>
        )}
        {props.data.label}
...
const relatedSuggestions = (selected) => {
    ...
    if (selectedValues.includes('nodejs') && !selectedValues.includes('typescript')) {
    ...
    if (suggestions.length < 3) {
        suggestions = [
            ...
            ...techOptions
                .map(opt => opt.value)
                .filter(val => !selectedValues.includes(val) && !suggestions.includes(val))
...
export default function BuiltWithSelect({ value, onChange }) {
    ...
    return (
        <div>
            ...
            />
            <div className="mt-6">
                <div className="font-semibold mb-2 text-gray-500 text-base">Suggested</div>
                <div className="flex flex-wrap gap-2">
                    {relatedSuggestions(value).map(opt => (
                        <button
                            ...
                            onClick={() => {
                                if (!value.find(v => v.value === opt.value) && value.length < 10) {
                                    onChange([...value, opt]);
                                }
                            }}
                        >
                            <span className="w-6 h-6 mr-2 flex items-center justify-center">{opt.icon && opt.icon}</span>
                            {opt.label}
            ...
            {value.length === 0 && (
                <div className="text-xs text-red-500 mt-2">Please select at least one technology.</div>
            )}
        </div>
    );
} 