            ...
            <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-gray-600 mb-4 leading-relaxed">
                            ...
                            Discover, launch, and grow your next big idea.
                        </p>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="mailto:skypher206@gmail.com" className="text-gray-400 hover:text-blue-600 transition-colors">
                    ...
                    {/* Platform Links */}
                    <div>
                        <h4 className="font-semibold text-gray-900 text-lg mb-4">Platform</h4>
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link to="/submit" className="text-gray-600 hover:text-blue-600 transition-colors">
                                    Submit Startup
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="https://startup.jobs/" className="text-gray-600 hover:text-blue-600 transition-colors">
                                    Startup Jobs
                                </a>
                            </li>
                        </ul>
                    ...
                    {/* Resources Links */}
                    <div>
                        <h4 className="font-semibold text-gray-900 text-lg mb-4">Resources</h4>
                        <ul className="space-y-3">
                            <li>
                                <Link to="/news" className="text-gray-600 hover:text-blue-600 transition-colors">
                                    Blog
                            ...
                            <li>
                                <Link to="/aboutus" className="text-gray-600 hover:text-blue-600 transition-colors">
                                    About Us
                                </Link>
                            </li>
                            <li>
                ...
                <div className="border-t border-gray-200 pt-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0 text-xs">
                        ...
                        <Link to="/suggestions" className="text-sm text-blue-600 hover:underline font-medium">
