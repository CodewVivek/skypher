...
const TermsOfService = () => (
    <div className="max-w-3xl mx-auto py-12 px-4">
        ...
        <p className="mb-4">Welcome to Launch It! These Terms of Service govern your use of our platform. By using Launch It, you agree to these terms.</p>
        <h2 className="text-xl font-semibold mt-8 mb-2">1. Acceptance of Terms</h2>
        <p className="mb-4">By accessing or using Launch It, you agree to be bound by these Terms of Service and our Privacy Policy.</p>
        <h2 className="text-xl font-semibold mt-8 mb-2">2. User Accounts</h2>
        <ul className="list-disc ml-6 mb-4">
            <li>You must provide accurate and complete information when creating an account (via Google sign-in).</li>
        ...
        <ul className="list-disc ml-6 mb-4">
            <li>You retain ownership of the content you submit to Launch It (projects, comments, etc.).</li>
            <li>By posting content, you grant us a license to use, display, and distribute it on the platform.</li>
